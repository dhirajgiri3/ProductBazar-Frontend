  ...
  if (authLoading && !user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <LoadingSpinner size="md" color="violet" text="Loading verification..." />
      </div>
    );
  }
          ...
          <AnimatePresence mode="wait">
            {!otpSent ? (
              ...
              >
                  ...
                  <div className="relative">
                    ...
                    {isSubmitting && (
                      <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                        <LoadingSpinner size="sm" showBackground fullScreen color="violet" />
                      </div>
                    )}
                  </div>
                ...
                >
                  {isSubmitting ? (
                    <LoadingSpinner size="sm" color="white" showBackground fullScreen text="Sending Code..." inline />
                  ) : cooldown > 0 ? (
                    <LoadingSpinner size="sm" color="white" showBackground fullScreen text={`Resend in ${cooldown}s`} inline />
                  ) : (
                    <>
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  >
                    {cooldown > 0 ? (
                      <LoadingSpinner size="sm" showBackground fullScreen color="violet" inline />
                    ) : isSubmitting ? (
                      <LoadingSpinner size="sm" showBackground fullScreen color="violet" inline />
                    ) : (
                      <>
                ...
                >
                  {isSubmitting ? (
                    <LoadingSpinner size="sm" color="white" showBackground fullScreen text="Verifying..." inline />
                  ) : (
                    <>
