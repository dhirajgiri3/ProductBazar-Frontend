...
import ProjectViewsChart from "@/Components/Project/Analytics/ProjectViewsChart";
import ReferrersChart from "@/Components/Project/Analytics/ReferrersChart";
  ...
  if (loading || analyticsLoading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <LoadingSpinner size="md" color="violet" showBackground fullScreen text="Loading analytics..." />
      </div>
    );
  }
