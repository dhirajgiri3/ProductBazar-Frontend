        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                      ...
                      <div className="relative">
                        {categoriesLoading ? (
                          <div className="absolute right-3 top-1/2 -translate-y-1/2">
                            <LoadingSpinner size="sm" showBackground fullScreen color="gray" inline />
                          </div>
                        ) : null}
                        <select
                          id="product-category"
          ...
          {isLoading ? (
            <div className="flex items-center justify-center py-16">
              <LoadingSpinner size="md" color="violet" showBackground fullScreen text="Searching..." />
            </div>
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="visible">
              ...
              {hasMore && (
                <div className="flex justify-center mt-8">
                  ...
                  >
                    {isLoading ? (
                      <LoadingSpinner size="sm" showBackground fullScreen color="violet" text="Loading..." inline />
                    ) : (
                      'Load More Results'
                    )}
                  </button>
