...
import { FaComments, FaLightbulb, FaChevronDown, FaPaperPlane, FaHeart, FaRegHeart, FaReply, FaEdit, FaTrash, FaThumbsUp } from "react-icons/fa";
...
const SkeletonLoader = ({ count = 3 }) => {
  return (
    <div className="space-y-5">
      <LoadingSpinner text="Loading comments..." showBackground fullScreen size="lg" color="violet" />
    </div>
  );
};
...
const LoadMoreButton = ({ onClick, isLoading }) => {
  return (
    ...
    >
      {isLoading ? (
        <LoadingSpinner text="Loading..." showBackground fullScreen size="sm" color="violet" inline />
      ) : (
        <>
          <span>Load More</span>
