...
const HeroSection = ({ onSearch }) => {
  ...
  return (
    <motion.div
      className="bg-gradient-to-r from-violet-50 via-purple-50 to-indigo-50 rounded-2xl px-8 py-14 md:py-20 text-center shadow-sm mb-8"
      ...
      <motion.div className="w-full max-w-2xl mx-auto" variants={itemVariants}>
        <form onSubmit={handleSubmit} className="relative">
          <input
            ...
            className="w-full pl-5 pr-16 py-4 rounded-full text-gray-700 focus:outline-none focus:ring-2 focus:ring-violet-500 shadow-md bg-white"
          />
          <button
            type="submit"
