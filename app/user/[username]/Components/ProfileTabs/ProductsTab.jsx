  ...
  if (isLoading && !products.length) {
    return (
      <div className="flex justify-center items-center py-16">
        <LoadingSpinner text="Loading products..." size="md" color="violet" showBackground fullScreen />
      </div>
    );
  }
      ...
      >
        ...
        {isLoading && products.length > 0 && (
          <div className="flex justify-center py-8">
            <LoadingSpinner text="Updating products..." size="md" color="violet" showBackground fullScreen />
          </div>
        )}
