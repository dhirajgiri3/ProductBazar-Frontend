...
export const FormField = ({
  ...
  placeholder = "",
  value,
  onChange = () => {}, // Provide default empty function
  error,
  disabled = false,
  icon, // Allow passing custom icon
}) => {
  const isError = !!error;
  // Normalize value to avoid null/undefined
        ...
        <div className="flex flex-wrap gap-2 p-3 pl-10 bg-white border border-gray-200 rounded-md transition-all duration-200 focus-within:border-violet-300 focus-within:ring-2 focus-within:ring-violet-100 hover:border-gray-300 min-h-[60px] shadow-sm">
          <AnimatePresence>
            {(tags || []).map((tag) => {
              ...
              const tagKey = typeof tag === 'string' ? tag : tag._id || tag.id || JSON.stringify(tag);
        ...
        <div className="mt-3 bg-gray-50 p-3 rounded-md border border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            {predefinedOptions.map((option) => {
              const isSelected = (tags || []).some(tag => {
  ...
  <div className="flex items-center justify-end space-x-4">
    ...
    {currentStep < totalSteps ? (
      <motion.button
        ...
        className="px-5 py-2.5 bg-violet-600 text-white text-sm rounded-md flex items-center space-x-2 transition-all duration-200 hover:bg-violet-700 shadow-sm border border-violet-700 hover:shadow-md"
        whileHover={{ x: 1, y: -1 }}
      ...
      <motion.button
        ...
        className={clsx(
          ...
          isSubmitting
            ...
            : "bg-violet-600 hover:bg-violet-700 border-violet-700 hover:shadow-md"
        )}
      ...
      >
        {isSubmitting ? (
          <div className="flex items-center justify-center">
            <LoadingSpinner size="sm" showBackground fullScreen color="white" text="Saving..." inline />
          </div>
        ) : (
          <>
