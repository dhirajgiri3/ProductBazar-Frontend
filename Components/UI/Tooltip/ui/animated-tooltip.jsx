      ...
      {items.map((item) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            width={44} // Corresponding to h-11 w-11 (11 * 4 = 44px)
            height={44} // Corresponding to h-11 w-11 (11 * 4 = 44px)
            quality={85} // Optimized quality
            className="object-cover border-2 border-white rounded-full group-hover:scale-105 group-hover:z-30 transition-transform duration-500"
          />
        </div>
      ))}
    </>
