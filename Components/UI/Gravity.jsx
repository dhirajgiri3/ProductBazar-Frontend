...
function parsePathToVertices(path, sampleLength = 15) {
  // For now, we'll use a simple approach without SVGPathCommander
  // You can add SVGPathCommander if needed for SVG support
  return [];
}
...
const Gravity = forwardRef(
  (
    ...
    const initializeRenderer = useCallback(() => {
      ...
      // Set up decomp for complex shapes
      try {
        const decomp = require("poly-decomp");
        Common.setDecomp(decomp);
      } catch (error) {
        console.warn("poly-decomp not available for complex shapes");
      }
