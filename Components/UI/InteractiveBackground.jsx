...
const InteractiveBackground = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
      <LoadingSpinner size="lg" color="violet" text="Loading background..." />
    </div>
  );
};
