  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 z-10">
        <span className="relative inline-flex items-center justify-center rounded-full text-white bg-gradient-to-br from-violet-500 to-violet-700 p-2 shadow-md shadow-violet-300/30 group-hover:shadow-violet-300/50 transition-all duration-500 group-hover:scale-110">
          {icon}
        </span>
        <p
          className={cn(
