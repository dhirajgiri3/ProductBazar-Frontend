...
function DisplayCards({ cards }) {
  ...
  return (
    <div className="grid [grid-template-areas:'stack'] place-items-center opacity-100 perspective-[2000px] h-[600px] transform-gpu rotate-y-[-10deg] hover:rotate-y-0 transition-all duration-1000">
