                             ...
                             {thumbnailProcessing ? (
                                <div className="absolute inset-0 flex items-center justify-center bg-white/80 z-10">
                                  <div className="text-center p-4">
                                    ...
                                    <p className="text-sm text-gray-700">Processing thumbnail...</p>
                                  </div>
                                </div>
                             ) : (
                                <>
            ...
            {/* Action Buttons */}
             <div className="flex space-x-3">
              ...
              <motion.button
                ...
                className="w-full px-6 py-3 bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-sm"
                disabled={submitting || !hasUnsavedChanges || categoriesLoading}
              >
                {submitting ? (
                  <LoadingSpinner size="sm" color="white" text="Saving..." inline />
                ) : (
                  <>
                    <Check size={18} />
                    Save Changes
