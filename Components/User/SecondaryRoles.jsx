              ...
              >
                ...
                {canModifyRoles && (
                  <button
                    ...
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? <LoadingSpinner size="xs" color="violet" showBackground fullScreen /> : <FiX />}
                  </button>
                )}
              </div>
            ))}
            ...
            <div className="border-t pt-3 mt-3">
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-violet-600 text-white rounded-md text-sm flex items-center"
                  disabled={!selectedRole || isSubmitting}
                >
                  {isSubmitting ? (
                    <LoadingSpinner size="sm" color="white" text="Adding..." inline />
                  ) : (
                    <>
                      <FiCheck className="mr-1" /> Add Role
                    </>
                  )}
                </button>
              </div>
