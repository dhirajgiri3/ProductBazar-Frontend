...
const EcosystemStats = () => {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      title: "Products with >6mo Traction",
      description: "1,200+",
      date: "Sustained Growth",
      iconClassName: "text-violet-500",
      titleClassName: "text-gray-900",
      className:
  ...
  return (
    <section
      ref={sectionRef}
      className="relative container mx-auto w-full overflow-hidden bg-white py-16"
    >
          ...
          >
            ...
            >
              <motion.div variants={itemVariants}>
                <SectionLabel
                  text="Our Ecosystem by the Numbers"
                  size="medium"
                  alignment="center"
                  variant="modern"
                  glowEffect={true}
