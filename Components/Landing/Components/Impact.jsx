      ...
      <div className="flex flex-col items-center z-10 relative mb-16 md:mb-24">
        ...
        >
          ...
          >
            ...
            >
              <SectionLabel
                text="Real Impact, Measurable Growth"
                size="medium"
                alignment="center"
                variant="modern"
                animationStyle="fade"
            ...
            >
              Getting started on ProductBazar is fast, intuitive, and designed for immediate value,
              ...
              {[
                {
                  ...
                  description: 'Active users retained over 6 months'
                },
                {
                  value: 5000,
                  label: 'Funding Raised',
                  icon: <Rocket className="w-4 h-4" />,
                  description: 'Total funding raised by platform users'
                },
                {
                  value: 94,
                  label: 'Partnerships Formed',
                  icon: <BarChart3 className="w-4 h-4" />,
                  description: 'Successful partnerships established'
                },
              ].map((stat, idx) => (
                <motion.div
                  key={idx}
                  ...
                  role="listitem"
                  aria-label={`${stat.label}: ${stat.value}${stat.label.includes('%') ? '%' : ''}`}
                >
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-violet-50 via-transparent to-indigo-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" aria-hidden="true"></div>
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <p className="text-gray-400 text-xs text-center mt-1" aria-label={stat.description}>
                      {stat.description}
                    </p>
                  </div>
                </motion.div>
