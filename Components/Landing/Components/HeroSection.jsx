...
const HeroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full text-gray-900 min-h-[90vh] flex items-center justify-center overflow-hidden py-12 sm:py-20"
          ...
          >
            ...
            >
              <motion.h1
                ...
                className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-gray-900"
              >
                Launch. Discover. Connect.
              </motion.h1>
            </motion.div>
            ...
            >
              Stop launching into the void. Get discovered by the right users, investors, and partners who actually want what you're building.
            </motion.p>
            ...
            >
              ...
              <motion.a
                ...
                aria-label="Discover products already launched on ProductBazar"
                onClick={() => setHasInteracted(true)}
              >
                <span className="relative z-10">See Live Products</span>
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-4" role="list" aria-label="Makers from top companies">
