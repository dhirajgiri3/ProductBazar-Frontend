...
const ProfileProductCard = ({
  ...
  const {
    ...
    if (!product) {
        return {
            productName: "", shortDescription: "", viewCount: 0, formattedDate: null, productUrl: "#",
            categoryName: "", productStatus: "", productTags: [], productTagsAll: [], galleryImages: [], launchDate: null,
        };
    }
  ...
  if (!product || !product._id) return null; // Basic validation, now after hooks
