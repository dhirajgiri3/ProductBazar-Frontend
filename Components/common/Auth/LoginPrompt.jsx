    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div className="relative p-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-violet-500 to-purple-600 text-white">
            ...
            <div className="p-6">
                ...
                <div className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      placeholder="Email"
                      className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 dark:focus:ring-violet-600 focus:border-violet-500 dark:focus:border-violet-600 transition-colors"
                    />
                  </div>
                  ...
                  <motion.button
                    className="w-full bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white py-2.5 rounded-lg font-medium shadow-lg shadow-violet-500/20 dark:shadow-violet-900/30 flex items-center justify-center"
              ...
              <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <a
                  ...
                  className="font-medium text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 hover:underline"
                >
                  Sign up
                </a>
              </div>
